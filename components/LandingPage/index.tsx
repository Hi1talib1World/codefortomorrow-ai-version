...
const LandingPage: React.FC<{ currentUser: User | null, onGetStarted: () => void }> = ({ currentUser, onGetStarted }) => {
  ...
  return (
    <div className="font-sans overflow-x-hidden selection:bg-[#FBBF24] selection:text-[#111827]">
      ...
      {/* Footer */}
      <footer className="bg-[#111827] text-slate-400 py-12 border-t border-[#111827]">
        <div className="container mx-auto px-6 text-center flex flex-col items-center">
          <img src="/assets/images/logo.png" alt="Code for Tomorrow" className="h-12 w-auto object-contain mb-8" />
          <div className="flex gap-6 mb-8 text-[#FBBF24] font-bold">
