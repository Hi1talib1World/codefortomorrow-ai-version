                ...
                <div className="container mx-auto px-6 py-4 flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        <button 
                            ...
                            className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg text-slate-500 dark:text-slate-355 hover:text-slate-800 dark:hover:text-white transition-colors cursor-pointer hidden sm:block"
                            title="App Launcher"
                        >
