    ...
    <div className="space-y-8 pb-24">
      <div>
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl font-black text-white tracking-tight">Good First Issues</h1>
        </div>
        <p className="text-slate-400 text-sm font-medium mb-8">Browse open issues labeled for beginners across active GitHub repositories.</p>
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
          <div className="relative w-full md:max-w-md">
            ...
            <input
              type="text"
              placeholder="Search a topic or repository..."
              value={query}
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-[#121212] rounded-2xl border border-slate-800">
          <p className="text-slate-500 font-semibold">No matching issues found.</p>
        </div>
      ) : (
            ...
            >
              <div className="flex items-start justify-between gap-4 mb-4">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-slate-500 text-sm mt-2 line-clamp-2">{issue.body || 'No description available.'}</p>
                </div>
              ...
              <div className="flex flex-wrap gap-3 items-center text-xs text-slate-400">
                ...
                <span className="inline-flex items-center gap-1"><MessageSquare className="w-3.5 h-3.5" /> {issue.comments} comments</span>
              </div>
