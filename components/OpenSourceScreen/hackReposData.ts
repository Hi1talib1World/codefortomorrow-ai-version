...
export const HACK_REPOS_DATA: RepoData[] = [
  {
    ...
    article: { title: 'PayloadsAllTheThings: The Ultimate Security Cheat Sheet', readTime: '5 min read', date: 'May 2026', sections: [
  ...
  },
  {
    ...
    article: { title: 'Metasploit: Professional Penetration Testing', readTime: '6 min read', date: 'May 2026', sections: [
  ...
  },
  {
    ...
    article: { title: 'Nmap: The Network Mapper Every Hacker Needs', readTime: '5 min read', date: 'May 2026', sections: [
  ...
  },
  {
    ...
    article: { title: 'OWASP Testing Guide: The Bible of Web Security', readTime: '5 min read', date: 'May 2026', sections: [
  ...
  },
  {
    ...
    article: { title: 'SQLMap: Automated SQL Injection Testing', readTime: '5 min read', date: 'May 2026', sections: [
  ...
  },
  {
    ...
    article: { title: 'Awesome Burp Extensions: Supercharge Web Testing', readTime: '4 min read', date: 'May 2026', sections: [
  ...
  },
  {
    ...
    article: { title: 'John the Ripper: Password Security Analysis', readTime: '5 min read', date: 'May 2026', sections: [
  ...
  },
  {
    ...
    article: { title: 'Ghidra: NSA\'s Reverse Engineering Powerhouse', readTime: '6 min read', date: 'May 2026', sections: [
  ...
  },
  {
    ...
    article: { title: 'Katoolin: Kali Tools on Any Linux Distro', readTime: '4 min read', date: 'May 2026', sections: [
